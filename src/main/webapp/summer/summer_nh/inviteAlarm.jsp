        ...
        <tbody>
            <c:forEach var="invite" items="${group}" varStatus="status">
                <tr>
                    ...
                    <td>${invite.idate}</td>
                    <td>
                        <a href="${pageContext.request.contextPath}/project/accept_alarm?pgsrn=${invite.pgsrn}&cno=${invite.cno}" class="btn btn-basic btn-xs" >수락</a>
                        <a href="${pageContext.request.contextPath}/project/refuse_alarm?pgsrn=${invite.pgsrn}&cno=${invite.cno}" class="btn btn-basic btn-xs" >거절</a>
                    </td>
                </tr>
            </c:forEach>
        </tbody>
